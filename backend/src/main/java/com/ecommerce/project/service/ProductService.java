...
public interface ProductService {
    ...
    ProductResponse getAllProductsForAdminDashboard(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder);

    ProductResponse getAllProductsForSellerDashboard(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder);
}
